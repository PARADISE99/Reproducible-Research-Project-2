...
### Synonpsis  
The major aim of this report to analyze the impact of different weather events on public health and economy based on the storm database collected from the U.S. National Oceanic and Atmospheric Administration's (NOAA) from 1950 - 2011. We will use the estimates of injuries, fatalities, property and crop damage to decide which types of event are most harmful to the economy and population health. From this data, we found that excessive heat and tornado are most harmful with respect to population health, while flood, drought, and hurricane/typhoon have the greatest economic consequences.
...
### Data Processing
Set appropriate path to the data.
```{r}
setwd("F:/Coursera/R_Programming/Repreducible-Research/Week-04/Project-2")
```
```{r}
  stormData <- read.csv("Project02Data.csv", sep = ",")
